...
from utils.configuration import read_yaml_cfg
...
if __name__ == '__main__':
    ...
    parser.add_argument('--learning_rate_max',
                        type=float,
                        default=0.005,
                        help='highest learning rate of 1 cycle scheduler')

    parser.add_argument('--training_buffer_size',
                        type=int,
                        default=8000000,
    ...
    parser.add_argument(
        ...
        default=5120,
        help=
        'number of patches for each parameter update (has to be a multiple of 512)'
    )
    ...
    parser.add_argument('--use_half',
                        type=_strtobool,
                        default=True,
                        help='train with half precision')

    parser.add_argument('--use_homogeneous',
                        type=_strtobool,
                        default=True,
                        help='train with half precision')
    ...
    parser.add_argument('--depth_target',
                        type=float,
                        default=10,
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        'split the training sequence in this number of clusters. disabled by default'
    )
